  ...
  return (
    ...
    <>
      ...
      {/**   <p className="m-4 text-white text-[16px] font-jua">
        ...
        */}
      <div className={`flex justify-start mb-5   ${lang == "ar" ? 'justify-end mr-3 ' : 'justify-start ml-2 '}  `} >
      <h2 className="text-white">    {lang == "ar" ? ': الاصناف' : 'Categories:'}</h2>
      </div>
        ...
        {sortedCategories &&
          sortedCategories.map((cat) => {
                return (
                  <div key={cat.id}>
                    <div className="focus-within:text-[#ab714d] mx-2">
                      ...
                      <h1 className=" py-2 cursor-pointer sm:text-base text-md  pb-1  text-[#D0B8A8] font-jua whitespace-normal">
